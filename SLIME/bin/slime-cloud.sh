...
if [ $# -lt 5 ] ; then
    echo "USAGE: "
    echo "run-solver.sh PROFILE PROJECT_NAME COMP_S3_PROBLEM_PATH NUM_PROCESSES JOB_NAME_SUFFIX COMP_OPTIONS "
    echo "where: "
...
aws --profile $1 batch submit-job --job-name $2-$5 --job-queue JobQueue-$2 --job-definition JobDefinition-$2 --node-overrides \
"
{
